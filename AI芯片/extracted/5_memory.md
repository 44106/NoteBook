...
## Slide 1: Computer Arch. & AI ChipLecture 5: Memory Overview, Organization & Technology

### Extracted Shape Text
- Computer Arch. & AI ChipLecture 5: Memory Overview, Organization & Technology
- Prof. Zeke Wang
- Zhejiang University
- 2 April 2026
...
## Slide 2: Recall: In-Order Superscalar Processor

### Extracted Shape Text
- Recall: In-Order Superscalar Processor
...
## Slide 3: Recall: Flynn’s Taxonomy of Computers
...
## Slide 4: Recall: Intuition of SIMD Capability

### Extracted Shape Text
- Recall: Intuition of SIMD Capability
...
## Slide 5: Recall: How to Support Vector Insns?

### Extracted Shape Text
- Recall: How to Support Vector Insns?
- VRF VALU VMemory

## Slide 6: Recall: Multithreaded Pipeline Example
...
## Slide 7: Recall: Large Superscalar vs. Multi-Core

- Images: 1; Tables: 0

### Extracted Shape Text
- Recall: Large Superscalar vs. Multi-Core
- Olukotun et al., “The Case for a Single-Chip Multiprocessor,” ASPLOS 1996.
- Vs.
- Large Superscalar
- Multi-Core

## Slide 8: Recall: Multi-Core over Large Superscalar
